...
#define CACHE_DIR_MAJOR_VERSION     19
...
enum CacheEventType
{
  ...
  //
  CACHE_EVENT_META_FROM_WRITER = CACHE_EVENT_EVENTS_START + 80,
  CACHE_EVENT_DATA_FROM_WRITER,
  CACHE_EVENT_WRITER_CLOSED,
  CACHE_EVENT_WRITER_ABORTED
};
